...
class MarketplacesControllerTest < ActionController::TestCase
  ...
  test "should create marketplace" do
    assert_difference('Marketplace.count') do
      post :create, marketplace: { Customer_id: @marketplace.Customer_id, Order_id: @marketplace.Order_id, Price: @marketplace.Price, Product_Name: @marketplace.Product_Name }
    end
  ...
  test "should update marketplace" do
    patch :update, id: @marketplace, marketplace: { Customer_id: @marketplace.Customer_id, Order_id: @marketplace.Order_id, Price: @marketplace.Price, Product_Name: @marketplace.Product_Name }
    assert_redirected_to marketplace_path(assigns(:marketplace))
  end
